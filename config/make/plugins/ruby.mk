...
local.ruby-exec = env ruby.ITEM=$(1) $(ruby.ENV) ruby -I$(core.GLOBAL_CONFIG_DIR) -r ruby-test-helper $(1) || exit $${?}
local.rspec-exec = env ruby.ITEM=$(1) $(ruby.ENV) rspec -I$(core.GLOBAL_CONFIG_DIR) -r ruby-spec-helper $(2) $(1) || exit $${?}
