...
define ruby.docs.p.make
  ...
  docs:: ${call ruby.docs.p.top,$(1)}
	$(ruby.ENV) yard doc -c -o $$(<) -b $$(<)/.yardoc --yardopts $(ruby.docs.YARDOPTS) ${call ruby.docs.p.join,--main,FRONT_PAGE,$(1)} ${call ruby.docs.p.join,,INCLUDE,$(1)} - ${call ruby.docs.p.join,,PAGES,$(1)}
